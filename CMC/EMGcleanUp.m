...
proc.results_folder = 'J:\MEG_Research\CMC\results\';
...
%         cfg.megscale = 1;
%         cfg.eogscale = 5e-8;
        visRej        = ft_databrowser(cfg,preproc_data);
         
%         save(['j:\MEG_Research\CMC\',file_sub{subjLoop,condLoop}(1:end-4),...
%             '-trlVisRej.mat'], 'visRej')
...
%%
            ...
            EMGclean                          = ft_rejectartifact(cfg,data_import);
...
%%        
        ...
        cfg.artfctdef.reject                = 'nan';
        EMGclean                          = ft_rejectartifact(cfg,preproc_data);
        EMGclean.trial{1}(1,isnan(EMGclean.trial{1}))=0;
        plot(EMGclean.time{1},  EMGclean.trial{1})
